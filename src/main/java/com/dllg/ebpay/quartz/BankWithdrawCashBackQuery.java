...
public class BankWithdrawCashBackQuery extends QuartzJobBean {

    private static final Logger logger = LogManager.getLogger(BankWithdrawCashBackQuery.class);
    ...
    protected void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        scheduleService.bankWithdrawCashBackQuery();
    }
