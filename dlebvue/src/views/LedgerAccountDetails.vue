<template>
  <div style="margin: 0 auto; width: 500px;">
    <div style="border-bottom:2px solid #FF9933;padding-bottom:10px;font-weight:bold;font-size: large;color: #FF9933">
      交易详情
    </div>
    <el-form ref="transactionInfoForm" :model="transactionInfoForm" labelWidth="100px" labelPosition="right">
      <el-row v-if="transactionInfoForm.accountSubTradeAdjustUserId">
        <el-col :xs="24" :sm="20" :offset="1">
          <el-form-item label="交易子账户:">
            <div style="text-align: left">{{transactionInfoForm.accountSubTradeTakeCashAccountName}}</div>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row v-if="transactionInfoForm.accountSubTradeAdjustUserId">
      ...
      <el-row>
        <el-col :xs="24" :sm="20" :offset="1">
          <el-form-item label="备注:">
            <!--调账之前-->
            <div v-if="!transactionInfoForm.accountSubTradeAdjustUserId" style="text-align: left">
              {{transactionInfoForm.accountSubTradeBankRemark}}
            </div>
            <!--调账之后-->
            <div v-if="transactionInfoForm.accountSubTradeAdjustUserId" style="text-align: left">
              {{transactionInfoForm.accountSubTradeRemark}}
            </div>
          </el-form-item>
        </el-col>
      </el-row>
