    ...
    <div class="page-content">
      ...
      <el-form :inline="true" :model="searchForm" class="admin-search-form" align="left">
        ...
        <div class="admin-search-btns">
          <el-button type="primary" icon="el-icon-search" @click="getData()" :loading="this.isShowLoadingIcon" v-show="_btn('qiantaiyonghuguanli_query')">查询
          </el-button>
          <el-button type="primary" icon="el-icon-edit" @click="showDialogAdd" v-show="_btn('qiantaiyonghuguanli_add')">创建</el-button>
          <el-button type="primary" icon="el-icon-edit" @click="showDialogUpdate" v-show="_btn('qiantaiyonghuguanli_update')">修改</el-button>
          <el-button type="primary" icon="el-icon-close" @click="showDialog(0)" v-show="_btn('qiantaiyonghuguanli_disable')">禁用</el-button>
          <el-button type="primary" icon="el-icon-check" @click="showDialog(1)" v-show="_btn('qiantaiyonghuguanli_enable')">启用</el-button>
      ...
      <!--分页-->
      <el-pagination style="width: 410px;margin: 0 auto"
